...
Version  : 2.41
Release  : 38
URL      : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.41.tar.xz
Source0  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.41.tar.xz
Source1  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.41.tar.xz.sig
...
%prep
%setup -q -n xkeyboard-config-2.41
cd %{_builddir}/xkeyboard-config-2.41
pushd ..
cp -a xkeyboard-config-2.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707154906
