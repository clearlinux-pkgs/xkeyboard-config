...
#
# Source0 file verified with key 0x1732AA424A0E86B4 (svu@gnome.org)
#
Name     : xkeyboard-config
Version  : 2.21
Release  : 17
URL      : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.21.tar.bz2
Source0  : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.21.tar.bz2
Source99 : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.21.tar.bz2.sig
...
Group: Development
Requires: xkeyboard-config-data
Provides: xkeyboard-config-devel
...
%prep
%setup -q -n xkeyboard-config-2.21
...
export LANG=C
export SOURCE_DATE_EPOCH=1499532911
