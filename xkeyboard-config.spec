...
Source0  : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.18.tar.gz
...
%prep
%setup -q -n xkeyboard-config-2.18
