...
Source0  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.44.tar.xz
Source1  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.44.tar.xz.sig
Source2  : 0661D98FC933A145.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 0661D98FC933A145' gpg.status
%setup -q -n xkeyboard-config-2.44
cd %{_builddir}/xkeyboard-config-2.44
pushd ..
cp -a xkeyboard-config-2.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739153821
...
/usr/share/X11/xkb/symbols/ancient
...
/usr/share/X11/xkb/symbols/fkeys
