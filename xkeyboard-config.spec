...
Version  : 2.16
Release  : 8
URL      : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.16.tar.gz
Source0  : http://xorg.freedesktop.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.16.tar.gz
...
%prep
%setup -q -n xkeyboard-config-2.16
