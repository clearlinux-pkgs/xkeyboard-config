...
Source0  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.42.tar.xz
Source1  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.42.tar.xz.sig
...
%setup -q -n xkeyboard-config-2.42
cd %{_builddir}/xkeyboard-config-2.42
pushd ..
cp -a xkeyboard-config-2.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718233807
