...
Source0  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.43.tar.xz
Source1  : https://www.x.org/releases/individual/data/xkeyboard-config/xkeyboard-config-2.43.tar.xz.sig
...
%setup -q -n xkeyboard-config-2.43
cd %{_builddir}/xkeyboard-config-2.43
pushd ..
cp -a xkeyboard-config-2.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727901813
